...
A selected canary still audits already-managed public repositories and can report more prepared repositories than the selected addition count. Fleet phases emit secret-free progress while they perform remote reads; wait for the complete plan or phase result and check the process exit status before drawing conclusions.
