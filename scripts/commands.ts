...
export function commandReference(): string {
  ...
  return [
    ...
    '  pnpm sync',
    '      Compare all of routes.jsonc with provider configuration in either authority mode',
    '  pnpm sync -y                         [production write]',
    '      Apply the complete plan in legacy mode; active D1 requires an exact scope',
    '  pnpm sync --put-sub <name> -y         [production write]',
    '      Apply one explicitly selected local subscription, including its policy fields',
    '  pnpm sync --put-sink <name> -y        [production write]',
    '      Apply one selected sink; --put-retention and --put-operations select special keys',
    '  pnpm retention plan',
