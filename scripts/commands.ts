...
export function commandReference(): string {
  ...
  return [
    ...
    '      Audit public or explicitly selected private repositories and preview the fleet',
    ...
    'github:fleet options: --repo (repeatable), --profiles (requires --repo), --include-private (requires --repo), --retire (requires --repo), --secret-limit, -y/--yes (apply only)',
    ...
    '',
    'Release',
    '  npm version <major|minor|patch>      Check, commit, tag, and atomically push a release version',
